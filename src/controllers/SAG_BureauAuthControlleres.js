...
export const changeApplicationStatusToVerified = async(req,res) => {
  ...
  try {
    ...
    const updateResult = await db.update(Student_Application_Reference).set({ApplicationStatus : "Verified"}).where(eq(Student_Application_Reference.ApplicationID, applicationId))
...
export const changeApplicationStatusToUnVerified = async(req,res) => {
  ...
  try {
    ...
    const updateResult = await db.update(Student_Application_Reference).set({ApplicationStatus : "UnVerified"}).where(eq(Student_Application_Reference.ApplicationID, applicationId))
...
export const changeApplicationStatusToPending = async(req,res) => {
  ...
  try {
    ...
    const updateResult = await db.update(Student_Application_Reference).set({ApplicationStatus : "Pending"}).where(eq(Student_Application_Reference.ApplicationID, applicationId))
